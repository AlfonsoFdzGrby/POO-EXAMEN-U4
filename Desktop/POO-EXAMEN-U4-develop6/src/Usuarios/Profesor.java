...
public class Profesor extends Usuario {
    ...
    public Profesor(String nombre, String apellidos, LocalDate fechaNacimiento, String ciudad, String estado,
            String dirección, NombreDeCarrera nombreCarrera, boolean esHombre, double sueldo, NombreDeCarrera carrera, ArrayList<NombreDeMateria> materiasImpartidas) {
        super(nombre, apellidos, fechaNacimiento, ciudad, estado, dirección, esHombre, Rol.PROFESOR, nombreCarrera);
        this.sueldo = sueldo;
    ...
    public void registerProfesor(){
        ...
        Profesor profesor = new Profesor(nombre, apellidos, fechaNacimiento, ciudad, estado, direccion, nombreDeCarrera, esHombre, sueldo, nombreDeCarrera, null);
    }
}
